...
# Note that there is no instructor with first name `Andy`, so the manager will throw an exception
try:
...
print("\n")
# Find all full-time instructors with First Name starting with `Y` and learners count greater than 30000
