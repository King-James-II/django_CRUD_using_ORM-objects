...
# Function to write instructor data
...
# Function to write learner data
def write_learners():
    # Add Learners
    ...
    learner_john.save()
    learner_jamesd = Learner(first_name='James', last_name='Doe', dob=date(1990, 3, 16),
                           occupation='developer',
                           social_link='https://www.linkedin.com/jamesdoe/')
    learner_jamesd.save()
...
# Write new data for courses, instructors, lessons, and learners
write_courses()
write_instructors()
write_lessons()
write_learners()